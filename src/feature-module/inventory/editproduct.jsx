...
import { getBrand, getCategory, getProduct, getUnit, setToogleHeader, updateProduct } from "../../core/redux/action";
...
const EditProduct = () => {
  ...
  useEffect(() => {
    if (productId && posts.length > 0) {
      const x = posts.find((i) => i.productId == productId);
  ...
  }, [productId, posts, getCatList, getBrandList, unitList]);
  //Image
  const handleImage = (e) => {
  ...
  const handleSubmit = async () => {
    if (validate()) {
      if (getIsImageChange) {
        ...
        setFormData({ ...formData, imgPath: path });
        setImage(path);
        dispatch(updateProduct(productId, formData, path));
      }
      else {
        if (isImageVisible)
          dispatch(updateProduct(productId, formData, formData.imgPath));
        else
  ...
  const handleMinUom = (selected) => {
    ...
    setSelectMinUom(unitList.find((x) => x.value === selected));
  };
      ...
      <div className="content">
                          ...
                          <div className="row">
                            ...
                            <div className="col-lg-4 col-sm-12 col-12">
                              <div className="mb-3 add-product">
                                ...
                                <input type="number" className="form-control" placeholder="factor" ref={factorRef} value={formData.factor} onChange={(e) => setFormData({ ...formData, factor: e.target.value })} />
                            ...
                            <div className="row">
                              <div className="col-lg-4 col-sm-6 col-12">
                                <div className="input-blocks add-product">
                                  ...
                                  <input type="number" className="form-control" value={formData.cPrice} ref={cPriceRef} onChange={(e) => setFormData({ ...formData, cPrice: e.target.value })} required />
                              ...
                              <div className="col-lg-4 col-sm-6 col-12">
                                <div className="input-blocks add-product">
                                  ...
                                  <input type="number" className="form-control" value={formData.consumerPrice} onChange={(e) => consumer_KeyDown(e.target.value)} />
                                </div>
                              </div>
                              <div className="col-lg-4 col-sm-6 col-12">
                                <div className="input-blocks add-product">
                                  <label>Sale Price</label>
                                  <input type="number" className="form-control" value={formData.sPrice} ref={sPriceRef} onChange={(e) => salePrice_KeyDown(e.target.value)} required />
        ...
        <div className="col-lg-12">
          <div className="btn-addproduct mb-4">
            ...
            <button to={route.addproduct} className="btn btn-submit" onClick={handleSubmit}>Save Changes</button>
          </div>
        </div>
        {/* /add */}
      </div>
